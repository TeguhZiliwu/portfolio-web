                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        ...
                        <div className="flex items-center">
                            ...
                            <a href="https://github.com/TeguhZiliwu" target="_blank" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white" rel="noopener noreferrer">
                                <FaGithub />
                            </a>
                        </div>
                    </div>
